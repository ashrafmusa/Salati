                        ...
                        <table className="w-full text-right">
                           <thead>
                                <tr className="border-b-2 border-slate-100 dark:border-slate-700">
                                    <th className="p-3 text-sm font-semibold text-slate-500">الصنف</th>
                                    <th className="p-3 text-sm font-semibold text-slate-500">الفئة</th>
                                    <th className="p-3 text-sm font-semibold text-slate-500">السعر</th>
                                    <th className="p-3 text-sm font-semibold text-slate-500">المخزون</th>
