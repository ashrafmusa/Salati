...
const AdminOffersScreen: React.FC = () => {
    ...
    useEffect(() => {
        const fetchAllProducts = async () => {
             ...
             const items = itemsSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data(), type: 'item' } as StoreProduct));
             const bundles = bundlesSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data(), type: 'bundle' } as StoreProduct));
