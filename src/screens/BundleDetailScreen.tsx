        ...
        if (bundleDoc.exists()) {
          ...
          if (
            ...
            const extrasQuery = query(
              ...
              where(documentId(), "in", bundleData.availableExtras)
            );
              ...
              <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm">
                ...
                <ul className="space-y-2">
                  {bundleItems.map((item) => {
                    const content = bundle.contents.find(
                      (c) => c.itemId === item.id
                    );
                    return (
                      <li
                  ...
                  <div className="space-y-3">
                    {availableExtras.map((extra) => (
                      <div
                        ...
                        className={`flex items-center p-3 rounded-lg cursor-pointer border-2 transition ${
