...
const SearchResultsScreen: React.FC = () => {
    ...
    const productsWithRatings = useMemo(() => {
        ...
        return allProducts.map(p => {
            ...
            return ratingData ? { ...p, averageRating: ratingData.total / ratingData.count, reviewCount: ratingData.count } : p;
        });
    }, [allProducts, reviews]);
    ...
    const filteredProducts = useMemo(() => {
        return productsWithRatings.filter(product => {
            ...
            const matchesSearch = product.arabicName.toLowerCase().includes(lowerCaseQuery) || product.name.toLowerCase().includes(lowerCaseQuery);
