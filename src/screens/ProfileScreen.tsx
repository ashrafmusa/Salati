        ...
        <div>
            ...
            <div className="p-4 max-w-2xl mx-auto space-y-6">
                    ...
                    {isEditing ? (
                        <div className="space-y-4">
                            ...
                            <div>
                             ...
                             <div>
                                ...
                                <input 
                                    ...
                                    dir="ltr"
                                    className={`${inputClasses} ${!!signedUpWithPhone ? 'bg-slate-100 dark:bg-slate-800' : ''}`}
                                />
                            </div>
                            <div>
                            ...
                            <div className="flex justify-end space-x-2 space-x-reverse">
                                {!isProfileIncomplete && <button onClick={handleCancel} className="px-4 py-2 rounded-md bg-slate-200 dark:bg-slate-600">إلغاء</button>}
                                <button onClick={handleSave} disabled={isSaving} className="px-6 py-2 rounded-md bg-primary text-white w-24 flex justify-center items-center">
                                    {isSaving ? '...' : 'حفظ'}
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2 text-slate-700 dark:text-slate-200">
                            ...
                            <p><strong>رقم الهاتف:</strong> <span dir="ltr">{user?.phone}</span></p>
                ...
                <div className="text-center">
                    <button onClick={() => { logout().then(() => navigate('/')) }} className="flex items-center gap-2 mx-auto text-red-500 font-semibold p-2 rounded-md hover:bg-red-50 dark:hover:bg-red-900/50">
