...
// CRITICAL FIX: The Firestore document reference is moved outside the component.
// This makes it a stable constant that is created only once, preventing the listener
// in useEffect from being re-attached on every render, which was causing the save to fail.
...
const AdminSettingsScreen: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // The dependency array is now empty because settingsRef is a stable constant from the outer scope.
        return () => unsubscribe();
    }, []);
