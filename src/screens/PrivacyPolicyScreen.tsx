      ...
      <div className="max-w-4xl mx-auto p-6 sm:p-8 space-y-6 text-slate-700 dark:text-slate-300">
        <div className="prose dark:prose-invert max-w-none">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">
            سياسة خصوصية منصة سـلـتـي
          </h1>
          <p>آخر تحديث: 20 سبتمبر 2025</p>

          <h2 className="text-2xl font-bold mt-8">1. المعلومات التي نجمعها</h2>
          <p>
            نحن نجمع المعلومات التي تقدمها مباشرة إلينا. على سبيل المثال، نجمع
            المعلومات عندما تنشئ حسابًا، أو تقدم طلبًا، أو تتواصل معنا. قد تشمل
            هذه المعلومات:
          </p>
          <ul>
            <li>
              معلومات الاتصال (مثل الاسم، رقم الهاتف، عنوان البريد الإلكتروني)
            </li>
          ...
          <p>
            نحن لا نشارك معلوماتك الشخصية مع أطراف ثالثة إلا كما هو موضح في هذه
            السياسة أو عندما نحصل على موافقتك. قد نشارك المعلومات مع السائقين
            لمعالجة طلبات التوصيل الخاصة بك.
          </p>

          <h2 className="text-2xl font-bold mt-8">4. أمن البيانات</h2>
          <p>
            نتخذ تدابير معقولة لحماية معلوماتك من الفقدان والسرقة وسوء الاستخدام
            والوصول غير المصرح به. يتم تخزين جميع البيانات على خوادم Firebase
            الآمنة.
          </p>

          <h2 className="text-2xl font-bold mt-8">5. حقوقك</h2>
          <p>
            لديك الحق في الوصول إلى معلوماتك الشخصية التي نحتفظ بها وتحديثها
            وتصحيحها. يمكنك مراجعة معلومات حسابك وتحديثها في أي وقت عن طريق
