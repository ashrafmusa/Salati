...
const AdminCustomersScreen: React.FC = () => {
    ...
    useEffect(() => {
        setLoading(true);
        // FIX: Refactored onSnapshot and collection calls to use v8 compat syntax and fixed type hinting.
    ...
    const handleBulkRoleChange = async (newRole: User['role']) => {
        ...
        // FIX: Refactored writeBatch and related calls to use v8 compat syntax.
