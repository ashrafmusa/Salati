...
const DEFAULT_LOGO_URL = "https://res.cloudinary.com/dolmzcken/image/upload/v1756915579/ml9gwjd3vkqz84ban7lm.png";
    ...
    const unsubscribe = settingsRef.onSnapshot(docSnap => {
      if (docSnap.exists) {
        ...
        setSettings({
            ...
            isAnnouncementActive: data.isAnnouncementActive || DEFAULT_SETTINGS.isAnnouncementActive,
            theme: { ...DEFAULT_THEME, ...data.theme },
            loginIllustrationSvg: data.loginIllustrationSvg || DEFAULT_SETTINGS.loginIllustrationSvg,
        });
      } else {
