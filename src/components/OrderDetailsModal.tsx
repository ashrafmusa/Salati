            ...
            <div className="text-right space-y-1">
                {order.subtotal !== undefined && (
                    <div className="text-slate-600 dark:text-slate-300 text-md">
                        ...
                        <span className="font-semibold mr-2">{order.subtotal.toLocaleString()} ج.س</span>
                    </div>
                )}
                {order.deliveryFee !== undefined && order.deliveryFee > 0 && (
                    <div className="text-slate-600 dark:text-slate-300 text-md">
                        <span>رسوم التوصيل:</span>
                        <span className="font-semibold mr-2">{order.deliveryFee.toLocaleString()} ج.س</span>
                    </div>
                )}
                 <div className="text-slate-800 dark:text-slate-100">
                    <span className="text-lg">الإجمالي الكلي:</span>
                    <span className="text-3xl font-bold text-secondary mr-2">{order.total.toLocaleString()} ج.س</span>
                 </div>
            </div>
        </div>
      </div>
