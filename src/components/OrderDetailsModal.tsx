                    ...
                    <tbody>
                        {order.items.map(item => (
                            <tr key={item.cartId} className="border-b dark:border-slate-700">
                                ...
                                <td className="p-3 text-slate-600 dark:text-slate-300">{calculateItemAndExtrasTotal(item, item.selectedExtras)} ج.س</td>
                                <td className="p-3 text-slate-600 dark:text-slate-300">{calculateItemAndExtrasTotal(item, item.selectedExtras) * item.quantity} ج.س</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
