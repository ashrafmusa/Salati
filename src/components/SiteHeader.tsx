            ...
            <div className="px-4 sm:px-6 py-3 max-w-7xl mx-auto flex items-center gap-4">
                ...
                <div ref={searchRef} className="relative flex-grow md:flex-grow-0 md:w-64">
                    ...
                    {isDropdownOpen && suggestions.length > 0 && (
                        <div className="absolute top-full mt-2 w-full bg-white dark:bg-slate-800 rounded-lg shadow-xl border dark:border-slate-700 overflow-hidden animate-fade-in">
                            <ul>
