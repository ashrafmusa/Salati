          ...
          <div className="md:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><Link to="/" className="text-base text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary">الرئيسية</Link></li>
                <li><Link to="/cart" className="text-base text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary">عربة التسوق</Link></li>
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-500 dark:text-slate-400 tracking-wider uppercase">قانوني</h3>
              <ul className="mt-4 space-y-2">
