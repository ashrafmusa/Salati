        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
                منصة تسوق متكاملة توفر كل ما تحتاجه من المنتجات الغذائية إلى العقارات، مع تجربة مستخدم مبسطة.
            </p>
          </div>
          
          {/* Column 2: Contact & Social */}
          <div>
            <h3 className="text-sm font-semibold text-slate-500 dark:text-slate-400 tracking-wider uppercase">تواصل معنا</h3>
            <ul className="mt-4 space-y-3">
              <li>
                <a href={`mailto:${emailAddress}`} className="flex items-center gap-3 text-base text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors">
              ...
              {phoneNumber && (
                <li>
                  <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-base text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors">
          ...
          {/* Column 4: Newsletter */}
          <div>
            <h3 className="text-sm font-semibold text-slate-500 dark:text-slate-400 tracking-wider uppercase">ابق على اطلاع</h3>
            ...
            <form className="mt-4 sm:flex sm:max-w-md">
              ...
              <input type="email" name="email-address" id="email-address" autoComplete="email" required className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-md shadow-sm focus:ring-primary focus:border-primary bg-white dark:bg-slate-800" placeholder="أدخل بريدك الإلكتروني" />
              <div className="mt-3 rounded-md sm:mt-0 sm:mr-3 sm:flex-shrink-0">
                <button type="submit" className="w-full bg-primary flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:bg-secondary transition-colors">
                  اشترك
                </button>
              </div>
            </form>
