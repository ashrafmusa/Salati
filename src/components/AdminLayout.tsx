...
import { DashboardIcon, OrdersIcon, BasketsIcon, CustomersIcon, LogoutIcon, MenuIcon, CloseIcon, GiftIcon, TruckIcon, EyeIcon, CategoryIcon, ShieldCheckIcon, BeakerIcon, CogIcon } from '../assets/adminIcons';
...
const navLinks: NavLinkItem[] = [
  ...
  { to: '/products', label: 'إدارة المنتجات', icon: BasketsIcon, roles: ['admin', 'super-admin'] },
...
const Sidebar: React.FC<{ isOpen: boolean, setIsOpen: (isOpen: boolean) => void }> = ({ isOpen, setIsOpen }) => {
  ...
  const superAdminPaths = ['/users', '/categories', '/extras', '/settings'];
