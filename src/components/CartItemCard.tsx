    ...
    <div className="flex items-start bg-white dark:bg-slate-800 p-4 rounded-xl shadow-md border border-slate-100 dark:border-slate-700 gap-4">
      ...
      <div className="flex-grow space-y-2">
        <div className="flex justify-between items-start">
          ...
          <button onClick={() => removeFromCart(item.cartId)} className="text-slate-400 hover:text-red-500 dark:hover:text-red-400 p-1 transition-transform transform active:scale-90 flex-shrink-0" aria-label="Remove item">
