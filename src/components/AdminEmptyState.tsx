...
const AdminEmptyState: React.FC<AdminEmptyStateProps> = ({ icon: Icon, title, message, buttonText, onButtonClick }) => (
  <div className="text-center py-16 flex flex-col items-center">
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>
      {buttonText}
    </button>
  </div>
);
