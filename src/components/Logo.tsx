...
const LOGO_URL_FALLBACK = "https://res.cloudinary.com/dolmzcken/image/upload/v1756915579/ml9gwjd3vkqz84ban7lm.png";
...
const Logo: React.FC<LogoProps> = ({ wrapperClassName = '', imgClassName = '', textClassName = '', imgProps }) => {
