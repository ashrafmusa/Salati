  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative text-slate-500 dark:text-slate-300 hover:text-slate-700 dark:hover:text-white p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700"
      >
            ...
            {notifications.length > 0 ? (
              notifications.map((notification) => (
                <button
                  ...
                  className={`w-full flex items-start p-3 text-sm text-right hover:bg-slate-100 dark:hover:bg-slate-700 ${
                    !notification.read ? "bg-blue-50 dark:bg-sky-900/30" : ""
                  }`}
                >
                  {!notification.read && (
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 ml-3 flex-shrink-0"></div>
                  )}
